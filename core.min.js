...
function getFigureValueByUrl(t, e) {
    var o = void 0;
    return (o = t.match(/^(https?):\/\/(www\.)?youtube\.com\/watch.*v=([a-zA-Z0-9_-]+)/i)) || (o = t.match(/^(https?):\/\/(www\.)?youtu\.be\/([a-zA-Z0-9_-]+)/i)) ? e({
        embed: "/embed/youtube?url=" + encodeURIComponent(t)
    }) : (o = t.match(/^(https?):\/\/(www\.)?vimeo\.com\/(\d+)/i)) ? e({
        embed: "/embed/vimeo?url=" + encodeURIComponent(t)
    }) : (o = t.match(/^(https?):\/\/(www\.|mobile\.)?twitter\.com\/(.+)\/status\/(\d+)/i)) ? e({
        embed: "/embed/twitter?url=" + encodeURIComponent(t)
    }) : (o = t.match(/^(https?):\/\/(t\.me|telegram\.me|telegram\.dog)\/([a-zA-Z0-9_]+)\/(\d+)/i)) ? e({
        embed: "/embed/telegram?url=" + encodeURIComponent(t)
    }) : (o = t.match(/^data:(image\/gif|image\/jpe?g|image\/png|video\/mp4);base64,(.*)$/)) ? e("video/" == o[1].substr(0, 6) ? {
        video: t
    } : {
        image: t
    }) : ((o = t.match(/^(https?):\/\/\S+/i)) && !function() {
    ...
    $("iframe").map(function() {
        ...
        if (l && l == t) {
            ...
            this.setAttribute("width", "640"),
                this.setAttribute("height", Math.round(640 * i) + ""),
            this.parentNode && this.parentNode.classList.contains("iframe_helper") && (this.parentNode.style.paddingTop = 100 * i + "%"),
...
function initQuill() {
    ...
    function l(t, e, l) {
        ...
        if (r = c[0])
            (!r.prev || r.prev instanceof BreakBlot) && (a.scroll.deleteAt(--i, 1),
                s = !0);
        else {
            var d = a.scroll.descendant(BreakBlot, i - 1)
                , p = _slicedToArray(d, 1);
            r = p[0],
            r && (a.scroll.deleteAt(--i, 1),
                s = !0)
        }
        ...
        r || s || !t)
            a.insertText(i, "\n", Quill.sources.USER),
                a.setSelection(++i, Quill.sources.USER),
            (l.format.blockHeader || l.format.blockSubheader || l.format.blockBlockquote || l.format.blockPullquote) && n && a.formatLine(i, 1, {
                blockHeader: !1,
                blockSubheader: !1,
                blockBlockquote: !1,
                blockPullquote: !1
            ...
            r = m[0],
            !r || r.next || r.prev && r.prev instanceof BreakBlot || (a.insertEmbed(++i, "textBreak", !0, Quill.sources.SILENT),
                a.setSelection(i, 0, Quill.sources.SILENT))
        }
        return a.selection.scrollIntoView(),
            !1
    }
    function r(t) {
    ...
    var a = new MyQuill("#_tl_editor",{
        readOnly: !0,
        fileSizeLimit: T.uploadEnabled ? 5242880 : 0,
                    ...
                    "required enter": {
                        ...
                        handler: function(t, e) {
                            var o = this.quill.scroll.descendant(FieldBlot, t.index)
                                ...
                                , r = l[0];
                            return r && r.next && !$(r.next.domNode).text() ? (this.quill.setSelection(r.next.offset(this.quill.scroll), 0, Quill.sources.USER),
                                !1) : (this.quill.insertText(t.index, "\n", Quill.sources.USER),
                                !1)
                        }
                    },
                    "required tab prev": {
                        ...
                        handler: function(t, e) {
                            ...
                            if (null != o && null != o.prev && o.prev instanceof FieldBlot) {
                                var n = o.prev.offset(a.scroll)
                                    , s = o.prev.length();
                                return a.setSelection(n, s > 1 ? s : 0, Quill.sources.USER),
                                    !1
                            }
                            return !0
                        }
                        ...
                        handler: function(t, e) {
                            ...
                            if (null != o && o instanceof FieldBlot && null != o.next) {
                                ...
                                if (o.next instanceof FieldBlot) {
                                    ...
                                    a.setSelection(n, 0, Quill.sources.USER);
                                return !1
                            }
                            return !0
                        }
                    ...
                    "detect embed": {
                        ...
                        handler: function(t, e) {
                            var o = a.scroll.line(t.index)
                                ...
                                , i = l[1];
                            return r && !function() {
                                var e = r.domNode.innerText
                                    , o = e.substr(0, i)
                                    , l = void 0;
                                if (l = o.match(/(^|\s)(https?:\/\/\S+)$/)) {
                                    var n = l[2]
                                        , s = a.scroll.descendants(LinkBlot, t.index - n.length, n.length);
                                    s.length || a.formatText(t.index - n.length, n.length, "link", n, Quill.sources.USER),
                                    o.substr(0, i - n.length).trim().length || "P" != r.domNode.tagName || getFigureValueByUrl(n, function(t) {
                                        if (t) {
                                            var e = r.offset(a.scroll);
                                            return a.updateContents((new Delta).retain(e)["delete"](o.length).insert({
                                                blockFigure: t
                                            }), Quill.sources.USER),
                                                hideBlocksTooltip(),
                                                !1
                    ...
                    "pre wrap": {
                        ...
                        handler: function(t, e) {
                            ...
                            this.quill.scroll.deleteAt(l, o),
                                this.quill.formatLine(l, 1, "code-block", !0, Quill.sources.USER),
                    ...
                    code: {
                        ...
                        handler: function(t, e) {
                            if (!e.collapsed) {
                                ...
                                if (o.length > 1 || 1 == o.length && o[0]instanceof CodeBlock)
                                    return this.quill.format("code-block", !e.format["code-block"], Quill.sources.USER),
                                        !1;
                    ...
                    "figure delete": {
                        ...
                        handler: function(t, e) {
                            var o = a.scroll.line(t.index)
                                ...
                                , r = l[0];
                            l[1];
                            return !(r && r.prev && r.prev instanceof FigureBlot) || (e.empty && a.deleteText(t.index, 1, Quill.sources.USER),
                                a.setSelection(r.prev.offset(a.scroll)),
                                !1)
                        }
                    },
                    "field backspace": {
    ...
    return a.addContainer($tl_link_tooltip.get(0)),
        ...
        a.on(Quill.events.EDITOR_CHANGE, function(t, e) {
            if (t === Quill.events.SELECTION_CHANGE && a.isEnabled() && null != e) {
                checkFigureBlots(e),
                    checkTooltips(e);
                var o = a.getFormat(e);
                $tl_article.toggleClass("title_focused", !(!o.blockTitle && !o.blockAuthor)),
            ...
            t.forEach(function(t) {
                if ("childList" == t.type && !t.addedNodes.length && t.removedNodes.length) {
                    ...
                    if (!o && e && "BR" == e.tagName && "inline" == e.className) {
                        ...
                        !o || !e || "BR" == e.tagName && "inline" == e.className || "BR" != o.tagName || "inline" != o.className || o.nextSibling || o.parentNode && o.parentNode.removeChild(o)
                }
            })
        }),
...
function checkTooltips(t) {
    var e = quill.scroll.descendant(Block, t.index)
        , o = _slicedToArray(e, 2)
        , l = o[0];
    o[1];
    0 === t.length ? (hideFormatTooltip(),
        null == l || l instanceof FieldBlot || l instanceof BlockquoteBlot || l instanceof PullquoteBlot || l instanceof CodeBlock || l instanceof ListItem || $(l.domNode).text().length ? hideBlocksTooltip() : showBlocksTooltip(t)) : (null == l || l instanceof TitleBlot ? hideFormatTooltip() : (showFormatTooltip(t),
        toolbarUpdate(t)),
        hideBlocksTooltip())
}
...
function _uploadFile(t, e, o, l) {
    var r = new FormData;
    r.append("file", uploadDataToBlob(t)),
        $.ajax({
            url: "/upload",
            type: "POST",
            data: r,
...
function getPageContent(t) {
    ...
    return $("textarea,input", e).map(function() {
        ...
        t ? ($("h1:not(:has(br)),address:not(:has(br))", o).append("<br>"),
            o.html()) : ($("h1,address", o).remove(),
    ...
    $.ajax(T.apiUrl + "/save", {
        ...
        success: function(t) {
            return $tl_article.removeClass("tl_article_saving"),
                t.error ? (updateEditable(!0),
                    showError(t.error)) : (draftClear(),
...
function checkAuth() {
    T.editable && $.ajax(T.apiUrl + "/check", {
        ...
        success: function(t) {
            if (t.save_hash && (T.saveHash = t.save_hash),
            t.report_hash && (T.reportHash = t.report_hash,
                $tl_page_footer.addClass("tl_page_footer_visible")),
            (t.can_edit && T.saveHash || !T.pageId) && (t.short_name && $account.text(t.short_name),
                $tl_article.addClass("tl_article_editable")),
            !T.pageId && ($tl_article.addClass("tl_article_edit"),
            ...
            if (t.auth_alert && t.short_name) {
                ...
                t.migrate_count > 0 && t.migrate_hash ? (i += "<p>We can also add " + t.migrate_count + " Telegraph page" + (t.migrate_count > 1 ? "s" : "") + " from this browser to your account.</p>",
                    showAlert(i, {
                        close_btn: "Skip",
                        submit_btn: "Add",
                        submit: function() {
...
function toolbarUpdate(t) {
    ...
    if ($bold_button.toggleClass("active", !!e.bold),
        $bold_button.toggleClass("disabled", o || l || r),
        $italic_button.toggleClass("active", !!e.italic),
        $italic_button.toggleClass("disabled", o || l || r),
...
function updateEditableText(t, e) {
    "undefined" == typeof e && (e = isEdit()),
        e ? $(".editable_text:not(:has(.editable_input))", t).map(function() {
            ...
            var t = this.value
                , e = this.parentNode;
            return $(e).empty().text(t),
                e
        })
}
function updateEditable(t) {
    if ($tl_article.toggleClass("tl_article_edit", t),
        updateEditableText(),
    ...
    t && quill.focus()),
        ...
        $("h1", $tl_header).text(e.text()),
            $("address a", $tl_header).text(o.text()),
            l ? $("address a", $tl_header).attr("href", l) : $("address a", $tl_header).removeAttr("href"),
            hideLinkTooltip(),
            hideFormatTooltip(),
            hideBlocksTooltip()
    }
...
function updateReportFormState() {
    ...
    $report_form.toggleClass("copyright_selected", "copyright" == t.reason.value),
        $report_form.toggleClass("form_disabled", !!e),
    t.reason.value && t.comment.focus()
}
function sendReport() {
    if ($report_form.hasClass("form_disabled"))
        return !1;
    var t = $report_form.get(0);
    $report_popup.addClass("tl_popup_loading"),
        $.ajax(T.apiUrl + "/report", {
            data: {
                page_id: T.pageId,
            ...
            success: function(t) {
                $report_popup.removeClass("tl_popup_loading"),
                    hidePopup(),
                    showAlert('<i class="tl_alert_success"></i><h4>Report sent</h4><p>Telegraph moderators will review your report. Thank you!</p>', {
                        close_btn: "Done"
                    })
            }
        })
...
function tooltipUpdatePosition(t, e, o) {
    ...
    null != e) {
        ...
        if ("top" == o.position) {
            ...
            var d = r.top + i.top;
            c = !1,
            d < n.top && (i.top = l.bottom + o.padding,
                c = !0)
        } else if ("bottom" == o.position) {
            var p = !1;
            i.top = l.bottom + o.padding,
            (p = isOverElement(i, o.depend, o.dependPadding)) && (i.top = p.bottom + o.dependPadding);
            var h = r.top + i.top;
            c = !0,
            h > s.top && (i.top = l.top - i.height - o.padding,
            (p = isOverElement(i, o.depend, o.dependPadding)) && (i.top = p.top - i.height - o.dependPadding),
                c = !1)
        }
        i.left = Math.round(i.left),
            i.top = Math.round(i.top),
            t._range = e,
        o.minDelta && Math.abs(i.left - t._left) < o.minDelta && Math.abs(i.top - t._top) < o.minDelta || (t._left = i.left,
            t._top = i.top,
            t.css({
                left: i.left,
                top: i.top
    ...
    return _inherits(e, t),
        _createClass(e, null, [{
            ...
            value: function(t) {
                ...
                var l = t.substr(0, 1);
                return "/" != l && "#" != l && "tg://" != t.substr(0, 5) && "mailto:" != t.substr(0, 7) && o.setAttribute("target", "_blank"),
                    o
            }
        }, {
            key: "formats",
...
var BlockAuto = function(t) {
    ...
    return _inherits(e, t),
        _createClass(e, [{
            ...
            value: function(t) {
                var o = _get(e.__proto__ || Object.getPrototypeOf(e), "create", this).call(this, t);
                return o.setAttribute("dir", "auto"),
                    o
            }
        }]),
        e
...
ListAuto.blotName = "list",
    ListAuto.defaultChild = "list-item",
    ListAuto.tagName = ["OL", "UL"],
    ListAuto.allowedChildren = [ListItem],
...
var FigureBlot = function(t) {
    function e(t, o) {
        ...
        l.domWrapper = document.createElement("div"),
            ...
            l.domCaption.setAttribute("dir", "auto"),
        ...
        return o.image ? (l.appendImgNode(o.image),
            r = l.uploadData(o.image)) : o.video ? (l.appendVideoNode(o.video),
            r = l.uploadData(o.video)) : o.embed && l.appendIframeNode(o.embed),
        r && (l.domProgress = document.createElement("div"),
            ...
            $(l.domCursor).keydown(function(t) {
                ...
                if (e == Keyboard.keys.BACKSPACE) {
                    ...
                    quill.focus(),
                        quill.insertText(r, "\n", Quill.sources.USER),
                        quill.setSelection(r, 0, Quill.sources.USER),
                        t.preventDefault()
                }
            }),
            ...
            $(l.domCaption).keydown(function(t) {
                ...
                if (e == Keyboard.keys.ENTER) {
                    ...
                    var r = o.selection("getPos")
                        , i = o.val();
                    if (r.start != r.end)
                        i = i.substr(0, r.start) + i.substr(r.end),
                            o.val(i).selection("setPos", {
                                start: i.length,
                                end: i.length
                            });
...
$tl_tooltip.mouseover(function(t) {
    ...
    $link_button.click(function(t) {
        ...
        if (o) {
            ...
            toolbarPrompt($tl_tooltip, "Paste or type a link...", function(t) {
                t = t.trim(),
                "#" != t.substr(0, 1) && "/" != t.substr(0, 1) && "http://" != t.substr(0, 7) && "https://" != t.substr(0, 8) && "tg://" != t.substr(0, 5) && "mailto:" != t.substr(0, 7) && (t = t.indexOf("@") > 0 ? "mailto:" + t : "http://" + t),
                    quill.focus(),
                    quill.format("link", t),
                    toolbarUpdate(l)
            })
    ...
    $image_button.click(function() {
        if (T.uploadEnabled) {
                ...
                t.addEventListener("change", function() {
                    if (null != t.files && null != t.files[0]) {
                        ...
                        updatePhoto(e, function(e) {
                            ...
                            o.onload = function(e) {
                                getFigureValueByUrl(e.target.result, function(e) {
                                    if (e) {
                                        var o = quill.getSelection(!0);
                                        quill.updateContents((new Delta).retain(o.index)["delete"](o.length).insert({
                                            blockFigure: e
                                        }), Quill.sources.USER)
                                    } else
            ...
            if (r) {
                ...
                i || (r.domNode.setAttribute("data-placeholder", "Paste a link to image or video and press Enter"),
                    $(r.domNode).addClass("placeholder_once empty"),
                    hideBlocksTooltip())
            }
        }
    }),
    $embed_button.click(function(t) {
        ...
        if (r) {
            var i = $(r.domNode).text();
            i || (r.domNode.setAttribute("data-placeholder", "Paste a YouTube, Vimeo or Twitter link, and press Enter"),
                $(r.domNode).addClass("placeholder_once empty"),
                hideBlocksTooltip())
        }
    }),
